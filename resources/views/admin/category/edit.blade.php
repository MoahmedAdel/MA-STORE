            ...
            <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <nav>
                    <ol class="flex items-center gap-2">
                        ...
                        <li>
                            <a class="font-medium" href="{{ route('categories.index') }}">view /</a>
                        </li>
                        <li class="font-medium text-primary"><a href="{{ route('categories.edit', $category->id) }}">edit</a>
                        </li>
                    </ol>
                </nav>
            </div>
                    ...
                    <div class="flex sm:flex-col gap-5.5 p-6.5">
                                        ...
                                        <select name="parent_id"
                                            ...
                                            @forelse ($parents as $parent)
                                                @if ($parent->parent_id == null)
                                                    <option value="{{ $parent->id }}" class="text-body"
                        ...
                        <div class="w-1/2 sm:w-full">
                            ...
                            <div class="mb-5.5">
                                ...
                                <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-white dark:bg-form-input">
                                    <select name="status"
                                        ...
                                        :class="isOptionSelected && 'text-black dark:text-white'"
                                        @change="isOptionSelected = true">
                                        <option value="active" @selected($category->status == 'active') class="text-success">Active
                                        </option>
                                        <option value="upcoming" @selected($category->status == 'upcoming') class="text-warning">Upcoming
                                        </option>
                                        <option value="inactive" @selected($category->status == 'inactive') class="text-danger">InActive
                                        </option>
                                    </select>
                                    <span class="absolute right-4 top-1/2 z-10 -translate-y-1/2">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <div>
                                ...
                                <textarea rows="1" placeholder="Enter Description" name="description"
                                    class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">{{ $category->description }}</textarea>
                            </div>
